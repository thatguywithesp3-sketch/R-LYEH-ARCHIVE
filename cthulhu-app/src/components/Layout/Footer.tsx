      ...
      <ContentWrapper>
        <FooterContent>
          ...
          <FooterSection>
            ...
            <FooterLink to="/">About Cthulhu</FooterLink>
            <FooterLink to="/">Impact cases</FooterLink>
            <FooterLink to="/">Interaction methods</FooterLink>
          </FooterSection>
          <FooterSection>
            <FooterTitle>Contact</FooterTitle>
            <FooterLink to="/">Submit testimony</FooterLink>
            <FooterLink to="/">Submit report</FooterLink>
          </FooterSection>
        </FooterContent>
        <Copyright>
